...
author: Nils Bundi <nbundi@proton.me>
status: Draft
type: SRC
created: 2024-04-15
---
...
All SNIP-4626 vaults MUST implement the SNIP-2 standard including its optional metadata extensions.
...
All SNIP-4626 vaults MUST implement a set of additional functions enabling the management of the vault's underlying assets.
...
- _slippage_: Any difference between advertised share price and economic realities of
...
SNIP-4626 is fully backward compatible with the SNIP-2 standard and has no known compatibility issues with other standards.
