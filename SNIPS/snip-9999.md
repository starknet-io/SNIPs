...
- **Components**: 
  - `MAINNET/contracts/src/components/stwo_verification_component.cairo`
  - `MAINNET/contracts/src/components/pedersen_component.cairo`
  - `MAINNET/contracts/src/components/nullifier_component.cairo`
- **Tests**: `MAINNET/contracts/tests/test_zketh_wrapper.cairo`
